...
public class Alterar extends javax.swing.JFrame {
    ...
    private final Main main = new gui.Main();
    /**
    ...
    public Alterar() {
        ...
        jCbEstado.setSelectedItem("SC");
        String dia = cliente.getNascimento().toString().substring(8, 10);
        String mes = cliente.getNascimento().toString().substring(5, 7);
        String ano = cliente.getNascimento().toString().substring(0, 4);
        jFTnascimento.setText(dia+"/"+mes+"/"+ano);
    ...
    private void initComponents() {
        ...
        jBalterar.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
